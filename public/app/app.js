(function() {
    ...
    angular.module('app', ['ui.router', 'ui.router.breadcrumbs', 'app.$nodeServices','app.$searchService', 'app.search', 'app.results', 'app.overview', 'app.details', 'app.create','app.mySnippets','app.login'])
