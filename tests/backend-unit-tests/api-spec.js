...
describe("REST API Tests", function() {
    ...
    function mockDataListAllSnippets() {
        nock('https://api.github.com:443', {"encodedQueryParams": true})
            .get('/user/repos')
            .query({"access_token": "c6addb19bebb028d1085ca6cb1dcc9ced37422fc"})
            .reply(200, [{
                "id": 35961801,
                "name": "sss",
    ...
    function mockDataDeleteFile() {
        ...
        nock('https://api.github.com:443', {"encodedQueryParams":true})
            ...
            .query({"message":"MochaTestFile%20deletion","sha":"0519ecba6ea913e21689ec692e81e9e4973fbf73","access_token":"c6addb19bebb028d1085ca6cb1dcc9ced37422fc"})
    ...
    function mockDataSearch() {
        nock('https://api.github.com:443', {"encodedQueryParams":true})
            .get('/search/code')
            .query({"q":"idm+user%3Asss-storage","access_token":"c6addb19bebb028d1085ca6cb1dcc9ced37422fc"})
