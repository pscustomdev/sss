...
console.log("(KARMA Front-End Testing: 'main-page-spec')");
describe('SSS', function() {
    ...
    describe('Main/Search Page (sss.html)', function(){
        ...
        it('should get same results from submitSearch', function() {
            var searchTerm = "2";
            var mockPayload = [searchTerm];
            $httpBackend.expect('GET', '/api/snippet-search?q=' + searchTerm)
                .respond(mockPayload);
    
            searchService.submitSearch(searchTerm);
            $httpBackend.flush(); //This is when it actually makes the call.
    
            expect(searchService.arrSearchResults).toEqual(mockPayload);
        });   
        //
        // it('should get same results from submitSearch', function() {
        //     var mockPayload = ["2","ImCooler","Joe-Test","KentWasBeforeRob"];
        //     $httpBackend.expect('GET', '/api/snippets')
        //         .respond(mockPayload);
    ...
    // describe('Detail Page (detail.html)', function(){
    ...
    //     }));
    // });
    // describe('Overview Page (overview.html)', function(){
